                        ...
                        <div class="-m-2">
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="text" required id="password" name="name" value={{$shop->name}}
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="information" class="leading-7 text-sm text-gray-600">店舗名</label>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <div class="w-32">
                                        <x-shop-thumbnail :shop="$shop"></x-shop-thumbnail>
                                    </div>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="flex justify-around p-2 w-full mt-4">
                                    <button onclick="location.href='{{ route('owner.shops.index') }}'" type="button"
